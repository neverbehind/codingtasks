...
class CustomEntityRepository implements CustomEntityRepositoryInterface
{
    ...
    public function save(CustomEntityInterface $entity)
    {
        try {
            ...
            throw new \Magento\Framework\Exception\CouldNotSaveException(__('Unable to save entity'), $e);
        }
    ...
    public function delete(CustomEntityInterface $entity)
    {
        try {
            ...
            throw new \Magento\Framework\Exception\StateException(__('Unable to remove entity %1', $entity->getId()));
        }
